# PrivacyPolicy
Welcome to the CalculatorApp for Android!

This is an open source Android app developed by Bill Arico. The source code is available on GitHub under the MIT license; the app is also available on Google Play.
